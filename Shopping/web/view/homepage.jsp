	...
	<li class="dropdown" style="float:right">
		...
		<ul class="dropdown-menu">
          ...
          <span class="glyphicon glyphicon-user"></span>&nbsp;User
			...
			<li><a href="/cartlist"><span class="glyphicon glyphicon-th"></span>&nbsp;我的购物车</a></li>
			<li><a href="/view/history.jsp"> <span class="glyphicon glyphicon-book"></span>&nbsp;购买记录</a></li>
			<li class="divider"></li>
			<li>&nbsp;&nbsp;&nbsp;&nbsp;
...
<a href="/addBook?bookId=<%=b.getBookId()%>"><button  type="button" class="btn btn-danger"onclick="checkcart()">加入购物车</button></a>
</div>
</div>      </td>
		</tr>
